...
{
    public class MsftBase : IDisposable
    {
        // Property returns the namespace of the WMI class.
        public static string OriginatingNamespace => Properties.Environment.Default.Storage;
        ...
        public MsftBase(string ClassName)
        {
            CreatedClassName = ClassName;
            InitializeObject(null, null, null);
        }

        public MsftBase(string keyObjectId, string ClassName)
        {
            CreatedClassName = ClassName;
            InitializeObject(null, new ManagementPath(ConstructPath(keyObjectId)), null);
        }

        public MsftBase(ManagementScope mgmtScope, string keyObjectId, string ClassName)
        {
            CreatedClassName = ClassName;
            InitializeObject(mgmtScope, new ManagementPath(ConstructPath(keyObjectId)), null);
        }
        ...
        public MsftBase(ManagementPath path, string ClassName)
        {
            CreatedClassName = ClassName;
            InitializeObject(null, path, null);
        }

        public MsftBase(ManagementScope mgmtScope, ManagementPath path, ObjectGetOptions getOptions, string ClassName)
        {
            CreatedClassName = ClassName;
            InitializeObject(mgmtScope, path, getOptions);
        }

        public MsftBase(ManagementObject theObject, string ClassName)
        {
            CreatedClassName = ClassName;
            Initialize();
        ...
        public MsftBase(ManagementBaseObject theObject, string ClassName)
        {
            CreatedClassName = ClassName;
            Initialize();
            if (theObject != null && CheckIfProperClass(theObject) == true)
        ...
        private string ConstructPath(string keyObjectId)
        {
