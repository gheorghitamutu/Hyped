...
{
    public class ExternalEthernetPort : MsvmBase
    {
        public static string ClassName => $"Msvm_{nameof(ExternalEthernetPort)}";

        // Below are different overloads of constructors to initialize an instance of the class with a WMI object.
        public ExternalEthernetPort() : base(ClassName) { }

        public ExternalEthernetPort(string keyCreationClassName, string keyName, string keySystemCreationClassName, string keySystemName) : base(keyCreationClassName, keyName, keySystemCreationClassName, keySystemName, ClassName) { }

        public ExternalEthernetPort(ManagementScope mgmtScope, string keyCreationClassName, string keyName, string keySystemCreationClassName, string keySystemName) : base(mgmtScope, keyCreationClassName, keyName, keySystemCreationClassName, keySystemName, ClassName) { }

        public ExternalEthernetPort(ManagementPath path, ObjectGetOptions getOptions) : base(path, getOptions, ClassName) { }
        ...
        public ExternalEthernetPort(ManagementObject theObject) : base(theObject, ClassName) { }
        ...
        /*
         * If this property is true, then this Ethernet port can be connected to the switches and thus can provide connectivity to virtual machine.
         * If this property is false, then this Ethernet is not being used by the virtual machine networking architecture.
         */
        public bool IsBound
        {
            get
            {
                if (LateBoundObject[nameof(IsBound)] == null)
                {
                    return Convert.ToBoolean(0);
                }
                return (bool)LateBoundObject[nameof(IsBound)];
            }
        }
        ...
        public static List<ExternalEthernetPort> GetInstances() => GetInstances(null, null, null, ClassName).Cast<ManagementObject>().Select((mo) => new ExternalEthernetPort(mo)).ToList();

        public new static List<ExternalEthernetPort> GetInstances(string condition) => GetInstances(null, condition, null, ClassName).Cast<ManagementObject>().Select((mo) => new ExternalEthernetPort(mo)).ToList();

        public static List<ExternalEthernetPort> GetInstances(string[] selectedProperties) => GetInstances(null, null, selectedProperties, ClassName).Cast<ManagementObject>().Select((mo) => new ExternalEthernetPort(mo)).ToList();

        public static List<ExternalEthernetPort> GetInstances(string condition, string[] selectedProperties) => GetInstances(null, condition, selectedProperties, ClassName).Cast<ManagementObject>().Select((mo) => new ExternalEthernetPort(mo)).ToList();

        public static List<ExternalEthernetPort> GetInstances(ManagementScope mgmtScope, EnumerationOptions enumOptions) => GetInstances(mgmtScope, enumOptions, ClassName).Cast<ManagementObject>().Select((mo) => new ExternalEthernetPort(mo)).ToList();

        public static List<ExternalEthernetPort> GetInstances(ManagementScope mgmtScope, string condition) => GetInstances(mgmtScope, condition, null, ClassName).Cast<ManagementObject>().Select((mo) => new ExternalEthernetPort(mo)).ToList();

        public static List<ExternalEthernetPort> GetInstances(ManagementScope mgmtScope, string[] selectedProperties) => GetInstances(mgmtScope, null, selectedProperties, ClassName).Cast<ManagementObject>().Select((mo) => new ExternalEthernetPort(mo)).ToList();

        public static List<ExternalEthernetPort> GetInstances(ManagementScope mgmtScope, string condition, string[] selectedProperties) => GetInstances(mgmtScope, condition, selectedProperties, ClassName).Cast<ManagementObject>().Select((mo) => new ExternalEthernetPort(mo)).ToList();

        public static ExternalEthernetPort CreateInstance() => new ExternalEthernetPort(CreateInstance(ClassName));
