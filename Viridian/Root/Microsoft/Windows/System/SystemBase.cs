...
namespace Viridian.Root.Microsoft.Windows.System
{
    public class SystemBase : IDisposable
    {
        // Property returns the namespace of the WMI class.
        public static string OriginatingNamespace => Properties.Environment.Default.Microsoft;
        ...
        public SystemBase(string ClassName)
        {
            CreatedClassName = ClassName;
            InitializeObject(null, null, null);
        }

        public SystemBase(ManagementPath path, ObjectGetOptions getOptions, string ClassName)
        {
            CreatedClassName = ClassName;
            InitializeObject(null, path, getOptions);
        }

        public SystemBase(ManagementScope mgmtScope, ManagementPath path, string ClassName)
        {
            CreatedClassName = ClassName;
            InitializeObject(mgmtScope, path, null);
        }

        public SystemBase(ManagementPath path, string ClassName)
        {
            CreatedClassName = ClassName;
            InitializeObject(null, path, null);
        }

        public SystemBase(ManagementScope mgmtScope, ManagementPath path, ObjectGetOptions getOptions, string ClassName)
        {
            CreatedClassName = ClassName;
        ...
        public SystemBase(ManagementBaseObject theObject, string ClassName)
        {
            CreatedClassName = ClassName;
            Initialize();
            if (theObject != null && CheckIfProperClass(theObject) == true)
