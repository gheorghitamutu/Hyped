...
{
    public class EthernetSwitchPort : MsvmBase
    {
        public static string ClassName => $"Msvm_{nameof(EthernetSwitchPort)}";

        // Below are different overloads of constructors to initialize an instance of the class with a WMI object.
        public EthernetSwitchPort() : base(ClassName) { }

        public EthernetSwitchPort(string keyCreationClassName, string keyName, string keySystemCreationClassName, string keySystemName) : base(keyCreationClassName, keyName, keySystemCreationClassName, keySystemName, ClassName) { }

        public EthernetSwitchPort(ManagementScope mgmtScope, string keyCreationClassName, string keyName, string keySystemCreationClassName, string keySystemName) : base(mgmtScope, keyCreationClassName, keyName, keySystemCreationClassName, keySystemName, ClassName) { }

        public EthernetSwitchPort(ManagementPath path, ObjectGetOptions getOptions) : base(path, getOptions, ClassName) { }

        public EthernetSwitchPort(ManagementScope mgmtScope, ManagementPath path) : base(mgmtScope, path, ClassName) { }

        public EthernetSwitchPort(ManagementPath path) : base(path, ClassName) { }

        public EthernetSwitchPort(ManagementScope mgmtScope, ManagementPath path, ObjectGetOptions getOptions) : base(mgmtScope, path, getOptions, ClassName) { }

        public EthernetSwitchPort(ManagementObject theObject) : base(theObject, ClassName) { }

        public EthernetSwitchPort(ManagementBaseObject theObject) : base(theObject, ClassName) { }
        ...
        /*
         * The current I/O virtualization (IOV) offload usage on this port.
         * The usage is the amount of IOV resources in use on the port.
         */
        public uint IOVOffloadUsage
        {
            get
            {
                if (LateBoundObject[nameof(IOVOffloadUsage)] == null)
                {
                    return Convert.ToUInt32(0);
                }
                return (uint)LateBoundObject[nameof(IOVOffloadUsage)];
            }
        }
        ...
        /*
         * The current VMQ offloading usage on this port.
         * The usage is the amount of VMQ resources in use on the port.
         */
        public uint VMQOffloadUsage
        {
            get
            {
                if (LateBoundObject[nameof(VMQOffloadUsage)] == null)
                {
                    return Convert.ToUInt32(0);
                }
                return (uint)LateBoundObject[nameof(VMQOffloadUsage)];
            }
        }

        // Different overloads of GetInstances() help in enumerating instances of the WMI class.
        public static List<EthernetSwitchPort> GetInstances() => GetInstances(null, null, null, ClassName).Cast<ManagementObject>().Select((mo) => new EthernetSwitchPort(mo)).ToList();

        public new static List<EthernetSwitchPort> GetInstances(string condition) => GetInstances(null, condition, null, ClassName).Cast<ManagementObject>().Select((mo) => new EthernetSwitchPort(mo)).ToList();

        public static List<EthernetSwitchPort> GetInstances(string[] selectedProperties) => GetInstances(null, null, selectedProperties, ClassName).Cast<ManagementObject>().Select((mo) => new EthernetSwitchPort(mo)).ToList();

        public static List<EthernetSwitchPort> GetInstances(string condition, string[] selectedProperties) => GetInstances(null, condition, selectedProperties, ClassName).Cast<ManagementObject>().Select((mo) => new EthernetSwitchPort(mo)).ToList();

        public static List<EthernetSwitchPort> GetInstances(ManagementScope mgmtScope, EnumerationOptions enumOptions) => GetInstances(mgmtScope, enumOptions, ClassName).Cast<ManagementObject>().Select((mo) => new EthernetSwitchPort(mo)).ToList();

        public static List<EthernetSwitchPort> GetInstances(ManagementScope mgmtScope, string condition) => GetInstances(mgmtScope, condition, null, ClassName).Cast<ManagementObject>().Select((mo) => new EthernetSwitchPort(mo)).ToList();

        public static List<EthernetSwitchPort> GetInstances(ManagementScope mgmtScope, string[] selectedProperties) => GetInstances(mgmtScope, null, selectedProperties, ClassName).Cast<ManagementObject>().Select((mo) => new EthernetSwitchPort(mo)).ToList();

        public static List<EthernetSwitchPort> GetInstances(ManagementScope mgmtScope, string condition, string[] selectedProperties) => GetInstances(mgmtScope, condition, selectedProperties, ClassName).Cast<ManagementObject>().Select((mo) => new EthernetSwitchPort(mo)).ToList();

        public static EthernetSwitchPort CreateInstance() => new EthernetSwitchPort(CreateInstance(ClassName));
